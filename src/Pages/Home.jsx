...
const Home = () => {
  return (
    <div className="body1">
        ...
        <Link to="/productlist"><lottie-player src="https://assets5.lottiefiles.com/packages/lf20_q6wsiidu.json"  background="transparent" style={{width: "1300px", height: "300px"}}   speed="1"   hover loop  autoplay></lottie-player></Link>
        </div>
